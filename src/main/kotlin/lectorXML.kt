...
class lectorXML : DefaultHandler() {
    ...
    override fun startElement(uri: String, localName: String, element: String, attributes: Attributes) {
        currentElement = element
        // Añade una nueva linea por cada etiqueta que lee.
        content.append("\n$element: ")
    }

    override fun endElement(uri: String, localName: String, element: String) {
